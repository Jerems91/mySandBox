...
public class Catalogue implements Serializable {
	...
	public Catalogue() {
		...
		produits.put("5",new Produit("5","Micro-ondes",259,"Micro-ondes","../images/micro-ondes.png","Quel superbe micro-ondes !!!"));
		produits.put("6",new Produit("6","Shaker",119.99,"Shaker","../images/shaker.png","Quel superbe shaker !!!"));
		produits.put("7",new Produit("7","Toaster",129.99,"Toaster","../images/toaster.png","Quel superbe toaster !!!"));
